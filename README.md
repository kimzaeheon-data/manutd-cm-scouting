...
| 선수 | 타깃 A (앵커) | 타깃 B (마이누 백업) |
|---|---|---|
| Mateus Fernandes | 🥇 0.744 | 🥇 0.633 |
| Adam Wharton | 4위 0.539 | 2위 0.613 |
| Alex Scott | 2위 0.561 | 4위 0.492 |
| Sandro Tonali | 3위 0.542 | 3위 0.536 |
| Mason Mount | 5위 0.198 | 5위 0.159 |
...
> 1차 모델: 수비·압박저항·체력·운반·전진을 고려한 타깃 A와 타깃 B 우선순위
...
3. 5명 기준 MinMax 정규화 — 리그 전체 분포 기준으로 보강 시 더 견고해짐
